...
Numeric summaries of key stats help reveal a few observations on seasons played for the franchise, goals scored, and assists given by player position. These summaries were conducted on **NonActive** players who have definitely concluded their contributions to the franchise. Some of these are intuitive based on the name of the player position, but still worth noting:  
